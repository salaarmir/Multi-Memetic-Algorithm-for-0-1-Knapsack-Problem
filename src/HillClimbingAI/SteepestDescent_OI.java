...
/**
 * Performs the Steepest Descent algorithm with improving only moves on solutions
 */
public class SteepestDescent_OI {

    /**
     * Applies the Steepest Descent algorithm with only improving moves to a specific solution
     *
     * @param solution The solution to apply the algorithm to
     */
    public static void applySteepestDescent_OI(ArrayList<Integer> solution) {
    ...
    /**
     * Applies the Steepest Descent IO algorithm a specific number of times based on the depth of search
     *
     * @param solution The solution to apply the algorithm to
    ...
    public static void applyHeuristic(ArrayList<Integer> solution, double DOS) {
        ...
        if (DOS >= 0.0 && DOS < 0.2) {
            applySteepestDescent_OI(solution);
