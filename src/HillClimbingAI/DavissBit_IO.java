...
/**
 * Performs the Davis's Bit algorithm with improving only moves on solutions
 */
public class DavissBit_IO {

    /**
     * Applies Davis's Bit algorithm with only improving moves to a specific solution
     *
     * @param solution The solution to apply the algorithm to
     */
    public static void applyDavissBit_IO(ArrayList<Integer> solution) {
    ...
    /**
     * Applies the Davis's Bit IO algorithm a specific number of times based on the depth of search
     *
     * @param solution The solution to apply the algorithm to
